...
export function LegalNavCard({ lastUpdated }: LegalNavCardProps) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50/80 p-8 shadow-sm dark:border-white/10 dark:bg-white/5">
      <p className="text-sm/7 font-semibold uppercase tracking-[0.12em] text-gray-500 dark:text-mist-300">Legal</p>
            ...
            return (
              <li key={link.href}>
                <Link
                  ...
                  className={
                    isActive
                      ? 'block rounded-md bg-gray-500/15 px-3 py-2 text-sm font-semibold text-[#0F172A] dark:bg-gray-500/30 dark:text-mist-300'
