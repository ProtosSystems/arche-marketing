...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="h-5 w-5 dark:hidden" role="presentation" focusable="false">
        <path
          fill="currentColor"
          d="M21 14.5a1 1 0 0 0-1.35-.94 7 7 0 1 1-9.21-9.21A1 1 0 0 0 9.5 3 9 9 0 1 0 21 14.5Z"
        />
      </svg>
      <svg viewBox="0 0 24 24" className="hidden h-5 w-5 dark:block" role="presentation" focusable="false">
        <path
          fill="currentColor"
