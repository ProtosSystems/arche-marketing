...
export function FooterWithLinkCategories({
  ...
  return (
    <footer className={clsx('pt-16', className)} {...props}>
      <div className="bg-mist-950/2.5 py-24 sm:py-32 text-mist-950 dark:bg-white/5 dark:text-white">
        <Container className="flex flex-col gap-16">
          ...
          <div className="text-sm/7 text-slate-600 dark:text-slate-400">{fineprint}</div>
        </Container>
      </div>
    </footer>
  )
