  ...
  return (
      <>
        ...
        <Main>
          ...
          <div className="bg-white py-24 sm:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="max-w-4xl">
                ...
                <p className="mt-6 max-w-2xl text-lg text-pretty text-slate-700 sm:text-xl/8 dark:text-slate-300">
                  Arche is licensed as financial data infrastructure: flat, predictable, and scoped by coverage not
                  usage. No credits, overages or pricing tricks.
                </p>
              </div>
              <div
                  className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none dark:bg-gray-800/50 dark:ring-white/10">
                <div className="p-8 sm:p-10 lg:flex-auto">
                  <h3 className="text-2xl tracking-tight text-primary sm:text-3xl dark:text-slate-100">
                    Arche Research License
                  </h3>
                  <p className="mt-6 text-base/7 text-slate-700 dark:text-slate-300">
                    A single license for teams that require point-in-time fundamentals with preserved history. Arche is
                    designed for reproducibility, defensibility and long-lived integration.
                  </p>
                  <div className="mt-10 flex items-center gap-x-4">
                    <h4 className="flex-none text-sm/6 font-semibold text-[#3A4F7A] dark:text-mist-300">
                      What’s included
                    </h4>
                  ...
                  <ul
                      role="list"
                      className="mt-8 grid grid-cols-1 gap-4 text-sm/6 text-slate-700 sm:grid-cols-2 sm:gap-6 dark:text-slate-300"
                  >
                    {includedFeatures.map((feature) => (
                        <li key={feature} className="flex gap-x-3">
                          <CheckIcon
                              aria-hidden="true"
                              className="h-6 w-5 flex-none text-[#3A4F7A] dark:text-mist-300"
                          />
                          {feature}
                        </li>
                    ))}
                ...
                <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:shrink-0">
                  <div
                      className="rounded-2xl bg-gray-50 py-10 text-center inset-ring inset-ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16 dark:bg-gray-900 dark:inset-ring-white/10">
                    <div className="mx-auto max-w-xs px-8">
                      <p className="text-base font-semibold text-slate-600 dark:text-slate-400">Flat monthly license</p>
                      <p className="mt-6 flex items-baseline justify-center gap-x-2">
                        <span
                            className="text-5xl font-semibold tracking-tight text-primary dark:text-slate-100">$1,200</span>
                        <span
                            className="text-sm/6 font-semibold tracking-wide text-slate-600 dark:text-slate-400">USD</span>
                      </p>
                      ...
                      <p className="mt-6 text-xs/5 text-slate-600 dark:text-slate-400">
                        Coverage is defined at onboarding (universe and historical depth). Invoices and receipts
                        available for company reimbursement.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white py-6 sm:py-8 dark:bg-transparent">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div
                ...
                <div className="col-span-2">
                  ...
                  <p className="mt-6 text-base/7 text-slate-700 dark:text-slate-300">
                    Arche is designed from first principles around determinism and provenance. The goal is simple:
                    historical fundamentals that do not drift, so research and systems remain defensible over time.
                  </p>
                </div>
