    ...
    return (
        <div className={className}>
            ...
            `}
                ...
                {/* Outer background (keeps edges clean if used on contrasting surfaces) */}
                ...
                <g className="shadow">
                    ...
                    {/* Small MCP note (not a 4th column; keeps scope to API box) */}
