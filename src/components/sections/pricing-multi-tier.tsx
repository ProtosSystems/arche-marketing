  ...
  return (
    ...
    >
      <div className="self-stretch">
        ...
        <div className="mt-4 flex flex-col gap-4 text-sm/6 text-slate-700 dark:text-slate-300">{subheadline}</div>
        <ul className="mt-4 space-y-2 text-sm/6 text-slate-700 dark:text-slate-300">
